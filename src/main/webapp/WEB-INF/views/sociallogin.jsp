		...
		<div class="wrap">
			...
			<div class="account">
				...
				<c:forEach var="url" items="${urls}">
					<div class="span">
					 <a  href="${url.value}"><img alt="nest_logo" src="${pageContext.request.contextPath}/images/signin_img.png"></a>
	                	<%-- <a href="<c:url value='/oauth2/authorize' />" >
	                		<img src="${pageContext.request.contextPath}/images/gmail2.png" alt="">
	                		<button type="submit">
				...
				<%-- <div class="span1">
					<form name='TwitterSocialloginForm'
            		  action="<c:url value='${pageContext.request.contextPath}/auth/twitter?scope=email,user_about_me,user_birthday' />" method='POST'>
						<img src="${pageContext.request.contextPath}/images/twitter.png" alt="">
						<button type="submit">
				...
				<div class="span2">
					<form name='LinkedInSocialloginForm'
            		  action="<c:url value='../auth/linkedin' />" method='POST'>
						<img src="${pageContext.request.contextPath}/images/linkedin.png" alt="">
						<button type="submit">
